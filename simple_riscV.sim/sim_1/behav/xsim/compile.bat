...
REM
REM Generated by Vivado on Mon Nov 03 01:46:41 +0200 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_SRC_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_SRC_vlog.prj -log xvlog.log
